...
function ordenaArray($array)
{
    ...
    array_multisort($altura, SORT_DESC, $matricula, SORT_ASC, $array);

     for($i = 0; $i <= 5; $i++){?>
        <tr>
            <td><?php print $array[$i]['matricula']; ?></td>
            <td><?php print $array[$i]['altura']; ?></td>
        </tr>
    <?php }
